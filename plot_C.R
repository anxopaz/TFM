...
jpeg("capturas1.jpeg", width = 2000, height = 1500, res = 300)
...
jpeg("capturas2.jpeg", width = 2000, height = 1500, res = 300)
...
jpeg("capturas3.jpeg", width = 2000, height = 1500, res = 300)
