...
# f_1=c(seq(0.001,2.5*fmsy,length.out=round(number_years/4,0)),
#       seq(2.5*fmsy,0.001,length.out=round(number_years/4,0)),
#       seq(0.001,fmsy,length.out=round(number_years/4,0)),
#       rep(fmsy,number_years-3*round(number_years/4,0)))
...
legend(0.80*length(years)+years[1],0.40*max(IA_SPM_0),c("CV = 0",paste0("CV = ",CV)), 
